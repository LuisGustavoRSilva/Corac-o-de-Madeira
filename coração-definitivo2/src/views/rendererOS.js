...
let dateP = document.getElementById('inputDateP')
...
frmOS.addEventListener('submit', async (event) => {
    ...
    if (idClient.value === "") {
        ...
        console.log(idOS.value, idClient.value, statusOS.value, computer.value, serial.value, problem.value, obs.value, specialist.value, diagnosis.value, parts.value, total.value, dateP.value)
        if (idOS.value === "") {
            //Gerar OS
